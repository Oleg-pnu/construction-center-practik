						...
						<Card style={{ width: "26rem" }}>
							...
							<Card.Body>
								...
								<Card.Text>
									...
									The new project from the Budfoh company develops the idea of practical and comfortable housing. The complex is located near projects is stylish and practical facades.
								</Card.Text>
							</Card.Body>
						</Card>
					</Col>
					<Col>
						<Card style={{ width: "26rem" }}>
							...
							<Card.Body>
								...
								<Card.Text>
									The business card of all "Altair" projects is stylish and practical facades. The complex is located near the first project of the series, "Altair. Star town". The business card of all "Altair" projects is stylish and practical facades.
								</Card.Text>
							</Card.Body>
						</Card>
					</Col>
					<Col>
						<Card style={{ width: "26rem" }}>
							...
							<Card.Body>
								...
								<Card.Text>
									The business card of all "Altair" projects is stylish and practical facades. The apartment complex will border the former sanatorium-park zone, and it will be possible to get to the sea coast from there in 15 minutes.
								</Card.Text>
							</Card.Body>
						</Card>
					</Col>
				...
				<Row>
					...
					<Col mg={5}>
						<p>
							...
							the first in Odessa to use innovative but also Orthodox churches, a synagogue, an Arab cultural center,
							shopping and office centers. We do not just build residential complexes, but take responsibility for
							their further maintenance. The management company "Nash Dom" created by us serves more than software
							and engineering construction solutions: BIM modeling,
